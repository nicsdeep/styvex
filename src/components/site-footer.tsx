        ...
        <div className="grid grid-cols-2 gap-y-12 gap-x-6 md:grid-cols-4 lg:gap-8">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-sm text-muted-foreground">
              ...
              <li><Link to={"/category/womens-clothing" as any} className="hover:text-foreground transition-colors">Women's Clothing</Link></li>
              <li><Link to={"/category/handbags" as any} className="hover:text-foreground transition-colors">Handbags & Bags</Link></li>
              <li><Link to={"/category/jewelry" as any} className="hover:text-foreground transition-colors">Jewelry</Link></li>
            </ul>
          </div>
