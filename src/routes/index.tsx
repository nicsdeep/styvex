  ...
  head: () => ({
    meta: [
      { title: "STYVEX — Modern Women's Fashion & Lifestyle" },
      {
        name: "description",
        content:
          "Discover the latest in women's fashion, handbags, jewelry, and lifestyle at STYVEX.",
      },
    ],
  }),
  component: Index,
        ...
        <div className="absolute inset-0 hidden lg:block" aria-hidden="true">
          {HERO_IMAGES.map((image, index) => (
            <img
              ...
              style={{
                maskImage:
                  "linear-gradient(to right, transparent 0%, transparent 34%, black 68%, black 100%)",
                WebkitMaskImage:
                  "linear-gradient(to right, transparent 0%, transparent 34%, black 68%, black 100%)",
              }}
            />
        ...
        <div className="relative z-10 flex min-h-[68vh] max-w-2xl flex-col justify-center px-5 py-20 md:px-10 lg:min-h-[78vh] lg:px-14">
          ...
          >
            <span className="eyebrow text-muted-foreground">
              Considered pieces. Exceptional everyday.
            </span>
          </div>
        </div>
          ...
          <div className="overflow-hidden -mx-4 px-4" ref={emblaRef}>
            <div className="flex -ml-4 touch-pan-y py-4">
              {products.map((product, i) => (
                <div
                  key={product.id}
                  className="min-w-0 flex-[0_0_50%] pl-4 sm:flex-[0_0_45%] lg:flex-[0_0_20%] xl:flex-[0_0_16.666%]"
                >
                  <ProductCard
                    id={product.id}
                    name={product.name}
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="relative flex min-h-[350px] flex-col justify-center overflow-hidden rounded-[2rem] bg-gradient-to-br from-brand to-ink p-8 text-primary-foreground md:p-12">
          ...
          <p className="text-white/80 mb-8 max-w-sm">
            Grab our best deals of the season. Limited quantities available.
          </p>
          ...
          <Link
            to="/shop"
            className="w-fit rounded-full bg-background px-8 py-3 text-sm font-bold text-brand shadow-lg transition-transform hover:-translate-y-0.5"
          >
            Shop Sale Now
          </Link>
          ...
          <img
            ...
            alt="Sale Item"
            className="absolute -bottom-10 -right-10 w-64 h-64 object-cover rounded-full mix-blend-multiply opacity-50 rotate-[-20deg]"
          />
        </div>
        ...
        <div className="relative flex min-h-[350px] flex-col justify-center overflow-hidden rounded-[2rem] bg-ink p-8 text-primary-foreground md:p-12">
          ...
          <h3 className="font-display mb-4 text-4xl font-semibold leading-tight md:text-5xl">
            The effortless edit
          </h3>
          <p className="text-white/70 mb-8 max-w-sm text-sm">
            Discover the latest trends and fresh styles designed to make you stand out this season.
          </p>

          <Link
            to="/shop"
            className="relative z-10 w-fit rounded-full bg-background px-8 py-3 text-sm font-bold text-ink shadow-lg transition-transform hover:-translate-y-0.5"
          >
            Shop Collection
          </Link>
